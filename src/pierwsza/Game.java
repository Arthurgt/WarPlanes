...
/**
 * 
 * Klasa Game odpowiada min. za generowanie elementow graficznych, obslugê poziomow oraz ruch myszka i obsluge w menu
 */
public class Game extends Canvas implements Runnable, MouseListener, MouseMotionListener,ActionListener {
	...
	/**
	 * Zmienna wskazuj¹ca na dzialanie gry
	 */
	private boolean dziala = false;
	/**
	 * Zmienna zwiazana z przewijaniem tla
	 */
	public int pozycja = 0;
	/**
	 * Zmienna ktora opisuje aktualny etap gry
	 */
	public int poziom = 1;
	public int ktory = 1;
	/**
	 * Timer który jest wykorzystywany do pojawiania siê przeciwnikow
	 */
	public long timer2;
	/**
	 * Zmienna ktora oznacza zakonczenie gry
	 */
	public int koniecgry=0;
	public int cos = 0;
	public int cos2 = 700;
	/**
	 * Zmienna oznaczajaca bossa
	 */
	...
	/**
	 * Timer sluzacy zamknieciu gry po okreslonym czasie
	 */
	...
	/**
	 * Inicjuje mechanike najwa¿nejszych elementow gry
	 */
	private void tick() {
		handler.tick();
		hud.tick();
	 ...
	 * 
	 * 
	 * Funkcja zapobiega wychodzeniu obiektow poza ekran
	 * 
	 */ 
